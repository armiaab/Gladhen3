...
// LIBID for the module – defined here to remove the IDL/MIDL build dependency.
...
// Builds a gladhen2:/// URI with percent-encoded UTF-8 file paths.
void BuildGladhenUri(IShellItemArray* psiItemArray, WCHAR* uri, size_t uriSize) noexcept;

// Returns the icon path for the Gladhen3 application (exe icon or .ico fallback).
HRESULT GetGladhenIconPath(LPWSTR* ppszIcon) noexcept;

// Shared IExplorerCommand helpers – both COM classes delegate here.
...
// IExplorerCommand for image files  {748744E1-F3A0-40BA-B7B3-938A4734EC96}
...
// IExplorerCommand for PDF files  {748744E1-F3A0-40BA-B7B3-938A4734EC97}
